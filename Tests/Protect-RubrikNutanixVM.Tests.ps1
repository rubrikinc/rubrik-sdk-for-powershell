...
Describe -Name 'Public/Protect-RubrikNutanixVM' -Tag 'Public', 'Protect-RubrikNutanixVM' -Fixture {
    #region init
    ...
    Context -Name 'Parameter/SLA' {
        ...
        It -Name 'Should assign SLA' -Test {
            ( Protect-RubrikNutanixVM -id 'NutanixVirtualMachine:::aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee-vm-ffffffff-0000-1111-2222-333333333333' -SLA 'test-valid_sla_name' ).effectiveSlaDomainName |
    ...
    Context -Name 'Parameter/DoNotProtect' {
        ...
        It -Name 'Should be Unprotected' -Test {
            ( Protect-RubrikNutanixVM -id 'NutanixVirtualMachine:::aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee-vm-ffffffff-0000-1111-2222-333333333333' -DoNotProtect).effectiveSlaDomainId |
    ...
    Context -Name 'Parameter/DoNotProtect/5.2' {
        ...
        Mock -CommandName Submit-Request -Verifiable -ModuleName 'Rubrik' -MockWith {
            @{ 
                'id'                   = 'NutanixVirtualMachine:::aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee-ffffffff-0000-1111-2222-333333333333'
                'effectiveSlaDomainId' = 'UNPROTECTED'
            }
        }
        It -Name 'Should use the 5.2 endpoint' -Test {
            ...
            $Output = & {
                Protect-RubrikFileset -id 'NutanixVirtualMachine:::aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee-ffffffff-0000-1111-2222-333333333333' -DoNotProtect -Verbose 4>&1
            }
    ...
    Context -Name 'Parameter/Inherit' {
        ...
        It -Name 'Should be Inherited' -Test {
            ( Protect-RubrikNutanixVM -id 'NutanixVirtualMachine:::aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee-vm-ffffffff-0000-1111-2222-333333333333' -Inherit).effectiveSlaDomainId |
    ...
    Context -Name 'Parameter Validation' {
        ...
        It -Name 'Parameters DoNotProtect and Inherit cannot be simultaneously used' -Test {
            { Protect-RubrikNutanixVM -Id NutanixVirtualMachine:::aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee-vm-ffffffff-0000-1111-2222-333333333333 -DoNotProtect -Inherit} |
                Should -Throw "Parameter set cannot be resolved using the specified named parameters."
        }
    }
}
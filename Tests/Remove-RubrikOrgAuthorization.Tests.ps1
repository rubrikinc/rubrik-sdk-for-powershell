...
Describe -Name 'Public/Remove-RubrikOrgAuthorization' -Tag 'Public', 'Remove-RubrikOrgAuthorization' -Fixture {
    #region init
    ...
    Context -Name 'Results Validation' {
        ...
        It -Name 'Should Return Correct Organization Authorization info' -Test {
            $return = Remove-RubrikOrgAuthorization -ID 'Organization:::01234567-8910-1abc-d435-0abc1234d567' -ManageResource 'VirtualMachine:::aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee-vm-12345'
            ...
            $return.privileges.manageResource -contains "VirtualMachine:::aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee-vm-12345" | Should -BeExactly $false
        }
    ...
    Context -Name 'Parameter Validation' {
        ...
        It -Name 'Parameter Missing' -Test {
            { Remove-RubrikOrgAuthorization  -ID 'Organization:::01234567-8910-1abc-d435-0abc1234d567' } |

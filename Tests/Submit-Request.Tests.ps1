...
"data": [
    ...
    "eventSeriesId": "ec203598-ea31-4929-ad76-c98744c3d489",
    "relatedIds": [
        "MssqlDatabase:::427e4ac6-7add-4240-9cde-e102b82a04b1"
    ],
    "jobInstanceId": "PULL_REPLICATE_f6fe4db5-7f1a-4d51-a16c-0eef911dc033:::346"
    },
    {
...
'@
    ...
    Context -Name 'Method:Delete' {
        It 'Parse as PowerShell' {
            Mock -CommandName Test-PowerShellSix -Verifiable -ModuleName 'Rubrik' -MockWith {$true}
        }
        It 'Status:success' {
            Mock -CommandName Test-PowerShellSix -Verifiable -ModuleName 'Rubrik' -MockWith {$true}
        }
    ...
    Context -Name 'Method:Other' {
        Mock -CommandName Test-PowerShellSix -Verifiable -ModuleName 'Rubrik' -MockWith {
            $true
        }
        ...
        It 'Parse as PowerShell - Verify output object' {
            Submit-Request -Uri 1 -Method Post | Should -BeExactly $EventObject
        }

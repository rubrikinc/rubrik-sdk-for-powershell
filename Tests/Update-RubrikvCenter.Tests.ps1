...
Describe -Name 'Public/Update-RubrikvCenter' -Tag 'Public', 'Update-RubrikvCenter' -Fixture {
    #region init
    ...
    Context -Name 'Request Succeeds' {
        ...
        It -Name 'Should return QUEUED status' -Test {
            ( Update-RubrikvCenter -id '11111').status |

#Requires -Version 3
function Get-RubrikNodeProxyConfig
{
  <#  
    .SYNOPSIS
    ...
    .DESCRIPTION
    The Get-RubrikNodeProxyConfig cmdlet will retrieve information around the node members of a given cluster.
    ...
    .LINK
    https://rubrik.gitbook.io/rubrik-sdk-for-powershell/command-documentation/reference/Get-RubrikNodeProxyConfig
    ...
    .EXAMPLE
    Get-RubrikNode | Get-RubrikNodeProxyConfig 

...
function Export-RubrikVApp
{
  <#  
      ...
      .DESCRIPTION
      The Export-RubrikVApp cmdlet is used to export a snapshot from a protected vCD vApp.
      ...
      This will export the vApp snapshot with an id of 7acdf6cd-2c9f-4661-bd29-b67d86ace70b to a new vApp in the same Org VDC
     ...
     .EXAMPLE
      ...
      This will export the vApp snapshot with an id of 7acdf6cd-2c9f-4661-bd29-b67d86ace70b to a new vApp in the same Org VDC and remove existing network mappings from VM NICs
      ...
      This will export the vApp snapshot with an id of 7acdf6cd-2c9f-4661-bd29-b67d86ace70b to a new vApp in an alternate Org VDC
      ...
      This will retreive the latest snapshot from the given vApp 'vApp01' and perform a partial export on the first VM in the vApp.
      The VM will be exported into the existing parent vApp. Set the ExportMode parameter to 'ExportToNewVapp' parameter to create a new vApp for the partial export.

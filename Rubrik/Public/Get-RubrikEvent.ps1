...
function Get-RubrikEvent
{
  ...
  Param(
    ...
    [ValidateSet('Failure', 'Warning', 'Info', 'Running', 'Success', 'Canceled', 'Canceling', 'Queued', 'TaskSuccess', IgnoreCase = $false)]
    [Parameter(ParameterSetName="eventByID")]
    [Alias('event_status')]
    [string]$Status,
    ...
    [ValidateSet('Archive', 'Audit', 'AuthDomain', 'AwsEvent', 'Backup', 'BulkRecovery', 'Classification', 'CloudNativeSource', 'CloudNativeVm', 'Configuration', 'Connection', 'Conversion', 'Diagnostic', 'Discovery', 'Failover', 'Fileset', 'Hardware', 'HostEvent', 'HypervScvmm', 'HypervServer', 'Index', 'Instantiate', 'LegalHold', 'LocalRecovery', 'LogBackup', 'Maintenance', 'NutanixCluster', 'ProtectedObjectDeletion', 'Recovery', 'Replication', 'ResourceOperations', 'Storage', 'StorageArray', 'StormResource', 'Support', 'System', 'TestFailover', 'ThreatFeed', 'ThreatHunt', 'ThreatMonitoring', 'Tpr', 'Upgrade', 'UserIntelligence', 'VCenter', 'Vcd', 'VolumeGroup', 'UnknownEventType', IgnoreCase = $false)]
    [Alias('event_type')]
    [Parameter(ParameterSetName="eventByID")]
    [string]$EventType,
    ...
    [ValidateSet('ActiveDirectoryDomain', 'ActiveDirectoryDomainController', 'AggregateAhvVm', 'AggregateAwsAzure', 'AggregateHypervVm', 'AggregateLinuxUnixHosts', 'AggregateNasShares', 'AggregateOracleDb', 'AggregateSapHanaDb', 'AggregateStorageArrays', 'AggregateVcdVapps', 'AggregateVsphereVm', 'AggregateWindowsHosts', 'AppBlueprint', 'AppFlows', 'AuthDomain', 'AwsAccount', 'AwsEventType', 'Certificate', 'Cluster', 'ComputeInstance', 'DataLocation', 'Db2Database', 'Db2Instance', 'Ec2Instance', 'Envoy', 'ExchangeDatabase', 'Host', 'HypervScvmm', 'HypervServer', 'HypervVm', 'Informix', 'JobInstance', 'K8sCluster', 'K8sLabel', 'K8sNamespaceV2', 'K8sProtectionSet', 'K8sVirtualMachine', 'Ldap', 'LinuxHost', 'LinuxFileset', 'ManagedVolume', 'MongoCollection', 'MongoCollectionSet', 'MongoDatabase', 'MongoSource', 'Mssql', 'MysqldbDatabase', 'MysqldbInstance', 'NasFileset', 'NasHost', 'NasSystem', 'NasVolume', 'NutanixCluster', 'NutanixEra', 'NutanixPrismCentral', 'NutanixVm', 'OlvmManager', 'OlvmDatacenter', 'OlvmComputeCluster', 'OlvmHost', 'OlvmVirtualMachine', 'OpenstackEnvironment', 'OpenstackVirtualMachine', 'OracleDb', 'OracleHost', 'OracleRac', 'PostgresDbCluster', 'PublicCloudMachineInstance', 'SamlSso', 'SapHanaDb', 'SapHanaSystem', 'ShareFileset', 'SlaDomain', 'SmbDomain', 'SnapMirrorCloud', 'StorageArray', 'StorageArrayVolumeGroup', 'Storm', 'SupportBundle', 'UnknownObjectType', 'Upgrade', 'UserActionAudit', 'Vcd', 'VcdVapp', 'Vcenter', 'VmwareVm', 'VolumeGroup', 'WindowsHost', 'WindowsFileset', IgnoreCase = $false)]
    [Alias('object_type')]
    [Parameter(ParameterSetName="eventByID")]
    [string]$ObjectType,

...
FunctionsToExport = @('Connect-Rubrik', 'Disconnect-Rubrik', 'Export-RubrikDatabase', 
               ...
               'Get-RubrikDatabaseFiles', 'Get-RubrikDatabaseMount', 'Get-RubrikDatabaseRecoverableRange',
               'Get-RubrikFileset', 'Get-RubrikFilesetTemplate', 'Get-RubrikHost', 
               'Get-RubrikHyperVVM', 'Get-RubrikManagedVolume', 
               'Get-RubrikManagedVolumeExport', 'Get-RubrikMount', 'Get-RubrikNASShare',
               'Get-RubrikNutanixVM', 'Get-RubrikReport', 'Get-RubrikReportData', 
               ...
               'Get-RubrikVersion', 'Get-RubrikVM', 'Invoke-RubrikRESTCall', 
               'New-RubrikFileset','New-RubrikFilesetTemplate',
               'Move-RubrikMountVMDK', 'New-RubrikDatabaseMount', 'New-RubrikHost', 
               'New-RubrikManagedVolume', 'New-RubrikManagedVolumeExport', 'New-RubrikNASShare',
               'New-RubrikMount', 'New-RubrikReport', 'New-RubrikSLA', 
               'New-RubrikSnapshot', 'Protect-RubrikDatabase', 
               'Protect-RubrikFileset', 'Protect-RubrikHyperVVM', 
               'Protect-RubrikNutanixVM', 'Protect-RubrikTag', 'Protect-RubrikVM', 
               'Remove-RubrikDatabaseMount', 'Remove-RubrikFileset', 
               'Remove-RubrikHost', 'Remove-RubrikManagedVolume', 
               'Remove-RubrikManagedVolumeExport', 'Remove-RubrikMount', 'Remove-RubrikNASShare', 
               ...
               'Set-RubrikManagedVolume', 'Set-RubrikNASShare', 'Set-RubrikMount', 'Set-RubrikNutanixVM', 

...
FormatsToProcess = @('ObjectDefinitions/Rubrik.SLADomain.ps1xml','ObjectDefinitions/Rubrik.VMwareVM.ps1xml',
                ...
                'ObjectDefinitions/Rubrik.ProxySetting.ps1xml', 'ObjectDefinitions/Rubrik.NutanixCluster.ps1xml',
...
FunctionsToExport = @('Connect-Rubrik', 'Disconnect-Rubrik', 'Export-RubrikDatabase', 
               ...
               'Get-RubrikFileset', 'Get-RubrikFilesetTemplate', 'Get-RubrikHost', 'Get-RubrikGuestOsCredential',
               'Get-RubrikHyperVVM', 'Get-RubrikIPMI', 'Get-RubrikLDAP', 'Get-RubrikLogShipping', 
               ...
               'Get-RubrikProxySetting', 'Get-RubrikReportData', 'Get-RubrikRequest', 
               'Get-RubrikReplicationSource', 'Get-RubrikReplicationTarget', 'Get-RubrikSetting', 
               ...
               'Get-RubrikUnmanagedObject', 'Get-RubrikUser', 'Get-RubrikVApp', 'Get-RubrikVAppSnapshot', 'Get-RubrikVCD',   
               ...
               'Sync-RubrikTag', 'Update-RubrikHost', 'Update-RubrikVCD', 

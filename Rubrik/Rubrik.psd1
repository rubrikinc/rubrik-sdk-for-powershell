...
FunctionsToExport = @('Connect-Rubrik','Get-RubrikMount','Get-RubrikSLA','Get-RubrikVersion','New-RubrikMount','New-RubrikSnapshot','Remove-RubrikMount','Remove-RubrikSLA','Protect-RubrikVM','Sync-RubrikTag','Get-RubrikVM','Get-RubrikSnapshot','Protect-RubrikTag','Stop-RubrikVM','Start-RubrikVM','Set-RubrikVM','New-RubrikSLA','Get-RubrikRequest','Move-RubrikMountVMDK','Sync-RubrikAnnotation','Get-RubrikDatabase','Protect-RubrikDatabase','Get-RubrikFileset','Protect-RubrikFileset','Get-RubrikFilesetTemplate','Set-RubrikBlackout')
